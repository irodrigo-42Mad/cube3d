...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/13 12:02:47 by irodrigo          #+#    #+#             */
/*   Updated: 2020/09/12 14:40:03 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static __intmax_t	ft_get_num(t_struct *my_temp)
{
	__intmax_t	num;
	...
	if (my_temp->s_flag == 'D')
		...
		num = (__intmax_t)(va_arg(my_temp->args, __intmax_t));
...
static int		ft_get_digits(__intmax_t n)
{
	int digits;
...
static t_struct	*ft_mount(int al_left, __intmax_t n,
