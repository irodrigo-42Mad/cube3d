...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/12 20:37:18 by irodrigo          #+#    #+#             */
/*   Updated: 2020/09/12 14:23:08 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_putnbrmax_fd(__intmax_t n, int fd);
char			*ft_itoa_base(__uintmax_t num, __uintmax_t base, char c);
void			ft_putnbrumax_fd(__uintmax_t n, int fd);
