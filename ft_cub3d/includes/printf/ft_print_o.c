...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/12 14:42:50 by irodrigo          #+#    #+#             */
/*   Updated: 2020/09/12 14:44:30 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void			ft_initial_zero(int hash, __uintmax_t n)
{
	if (hash == 1 && n)
		write(1, "0", 1);
}

static __uintmax_t	ft_get_num(t_struct *my_temp)
{
	__uintmax_t	n;
	...
	if (my_temp->s_flag == 'O')
		...
		n = (__uintmax_t)(va_arg(my_temp->args, __uintmax_t));
...
static t_struct		*ft_mount(int lft, __uintmax_t n,
